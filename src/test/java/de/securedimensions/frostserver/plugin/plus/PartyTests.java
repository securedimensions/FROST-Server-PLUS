...
public class PartyTests extends AbstractTestClass {
	...
	public PartyTests(ServerVersion version) throws ServiceFailureException, IOException, URISyntaxException {
