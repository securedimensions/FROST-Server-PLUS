...
/**
 * Tests for the Observation class properties. According to the ownership concept, a
 * Observation's properties can only be changed by the user that 'owns' the Observation
 * via the Datastream instance. 
 *
 * @author Andreas Matheus
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class ObservationTests extends AbstractTestClass {
	...
	private static String DATASTREAM_INLINE_PARTY(String userId) {return String.format(DATASTREAM_INLINE_PARTY,userId,userId);}
	
	private static String DATASTREAM_EXISTING_PARTY(String userId) {return String.format(DATASTREAM_EXISTING_PARTY,userId,userId);}
	...
	private static String OBSERVATION_INLINE_DATASTREAM_INLINE_PARTY(String userId) {return String.format(OBSERVATION, DATASTREAM_INLINE_PARTY(userId));}

	private static String OBSERVATION_INLINE_DATASTREAM_EXTERNAL_PARTY(String userId) {return String.format(OBSERVATION, DATASTREAM_EXISTING_PARTY(userId));}
	
	private static String OBSERVATION_EXISTING_DATASTREAM (String dsId) { return String.format(String.format(OBSERVATION,String.format(DATASTREAM_EXISTING,dsId)));}
	...
	public ObservationTests(ServerVersion version) throws ServiceFailureException, IOException, URISyntaxException {
	...
	public void test10SameUserCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_201) {
			Assert.assertTrue(SAME_USER_SHOULD_BE_ABLE_TO_CREATE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test11SameUserCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_201) {
			Assert.assertTrue(SAME_USER_SHOULD_BE_ABLE_TO_CREATE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test12SameUserCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_201) {
			Assert.assertTrue(SAME_USER_SHOULD_BE_ABLE_TO_CREATE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test20OtherUserCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_403) {
			Assert.assertTrue(OTHER_USER_SHOULD_NOT_BE_ABLE_TO_CREATE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test21OtherUserCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_403) {
			Assert.assertTrue(OTHER_USER_SHOULD_NOT_BE_ABLE_TO_CREATE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test22OtherUserCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_403) {
			Assert.assertTrue(OTHER_USER_SHOULD_NOT_BE_ABLE_TO_CREATE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test30AnonCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_401) {
			Assert.assertTrue(ANON_SHOULD_NOT_BE_ABLE_TO_CREATE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test31AnonCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_401) {
			Assert.assertTrue(ANON_SHOULD_NOT_BE_ABLE_TO_CREATE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test32AnonCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_401) {
			Assert.assertTrue(ANON_SHOULD_NOT_BE_ABLE_TO_CREATE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test40AdminCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_201) {
			Assert.assertTrue(ADMIN_SHOULD_BE_ABLE_TO_CREATE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test41AdminCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_201) {
			Assert.assertTrue(ADMIN_SHOULD_BE_ABLE_TO_CREATE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test42AdminCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_201) {
			Assert.assertTrue(ADMIN_SHOULD_BE_ABLE_TO_CREATE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test50SameUserCreateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(SAME_USER_SHOULD_BE_ABLE_TO_DELETE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test51SameUserDeleteObservation() throws ClientProtocolException, IOException {
		...
		response = deleteObservation(response.getFirstHeader("Location").getValue(), LJS);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(SAME_USER_SHOULD_BE_ABLE_TO_DELETE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test52SameUserDeleteObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(SAME_USER_SHOULD_BE_ABLE_TO_DELETE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test60OtherUserDeleteObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_403) {
			Assert.assertTrue(OTHER_USER_SHOULD_NOT_BE_ABLE_TO_DELETE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test61OtherUserDeleteObservation() throws ClientProtocolException, IOException {
		...
		response = deleteObservation(response.getFirstHeader("Location").getValue(), ALICE);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_403) {
			Assert.assertTrue(OTHER_USER_SHOULD_NOT_BE_ABLE_TO_DELETE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test62OtherUserDeleteObservation() throws ClientProtocolException, IOException {
		...
		response = deleteObservation(response.getFirstHeader("Location").getValue(), ALICE);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_403) {
			Assert.assertTrue(OTHER_USER_SHOULD_NOT_BE_ABLE_TO_DELETE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test70AnonDeleteObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_401) {
			Assert.assertTrue(ANON_SHOULD_NOT_BE_ABLE_TO_DELETE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test71AnonDeleteObservation() throws ClientProtocolException, IOException {
		...
		response = deleteObservation(response.getFirstHeader("Location").getValue(), null);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_401) {
			Assert.assertTrue(ANON_SHOULD_NOT_BE_ABLE_TO_DELETE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test72AnonDeleteObservation() throws ClientProtocolException, IOException {
		...
		response = deleteObservation(response.getFirstHeader("Location").getValue(), null);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_401) {
			Assert.assertTrue(ANON_SHOULD_NOT_BE_ABLE_TO_DELETE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test80AdminDeleteObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(ADMIN_SHOULD_BE_ABLE_TO_DELETE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test81AdminDeleteObservation() throws ClientProtocolException, IOException {
		...
		response = deleteObservation(response.getFirstHeader("Location").getValue(), ADMIN);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(ADMIN_SHOULD_BE_ABLE_TO_DELETE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test82AdminCreateObservation() throws ClientProtocolException, IOException {
		...
		response = deleteObservation(response.getFirstHeader("Location").getValue(), ADMIN);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(ADMIN_SHOULD_BE_ABLE_TO_DELETE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test50SameUserUpdateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(SAME_USER_SHOULD_BE_ABLE_TO_UPDATE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test51SameUserUpdateObservation() throws ClientProtocolException, IOException {
		...
		response = updateObservation(response.getFirstHeader("Location").getValue(), LJS);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(SAME_USER_SHOULD_BE_ABLE_TO_UPDATE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test52SameUserUpdateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(SAME_USER_SHOULD_BE_ABLE_TO_UPDATE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test60OtherUserUpdateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_403) {
			Assert.assertTrue(OTHER_USER_SHOULD_NOT_BE_ABLE_TO_UPDATE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test61OtherUserUpdateObservation() throws ClientProtocolException, IOException {
		...
		response = updateObservation(response.getFirstHeader("Location").getValue(), ALICE);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_403) {
			Assert.assertTrue(OTHER_USER_SHOULD_NOT_BE_ABLE_TO_UPDATE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test62OtherUserUpdateObservation() throws ClientProtocolException, IOException {
		...
		response = updateObservation(response.getFirstHeader("Location").getValue(), ALICE);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_403) {
			Assert.assertTrue(OTHER_USER_SHOULD_NOT_BE_ABLE_TO_UPDATE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test70AnonUpdateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_401) {
			Assert.assertTrue(ANON_SHOULD_NOT_BE_ABLE_TO_UPDATE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test71AnonUpdateObservation() throws ClientProtocolException, IOException {
		...
		response = deleteObservation(response.getFirstHeader("Location").getValue(), null);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_401) {
			Assert.assertTrue(ANON_SHOULD_NOT_BE_ABLE_TO_UPDATE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test72AnonUpdateObservation() throws ClientProtocolException, IOException {
		...
		response = updateObservation(response.getFirstHeader("Location").getValue(), null);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_401) {
			Assert.assertTrue(ANON_SHOULD_NOT_BE_ABLE_TO_UPDATE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
	...
	public void test80AdminUpdateObservation() throws ClientProtocolException, IOException {
		...
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(ADMIN_SHOULD_BE_ABLE_TO_UPDATE_INLINE_DATASTREAM_INLINE_PARTY, Boolean.TRUE);
		} else {
	...
	public void test81AdminUpdateObservation() throws ClientProtocolException, IOException {
		...
		response = updateObservation(response.getFirstHeader("Location").getValue(), ADMIN);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(ADMIN_SHOULD_BE_ABLE_TO_UPDATE_INLINE_DATASTREAM_EXISTING_PARTY, Boolean.TRUE);
		} else {
	...
	public void test82AdminUpdateObservation() throws ClientProtocolException, IOException {
		...
		response = updateObservation(response.getFirstHeader("Location").getValue(), ADMIN);
		if (response.getStatusLine().getStatusCode() == HTTP_CODE_200) {
			Assert.assertTrue(ADMIN_SHOULD_BE_ABLE_TO_UPDATE_EXISTING_DATASTREAM, Boolean.TRUE);
		} else {
