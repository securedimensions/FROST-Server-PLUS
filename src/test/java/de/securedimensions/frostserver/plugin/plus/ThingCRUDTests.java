...
public class ThingCRUDTests extends AbstractTestClass {
	...
	private static final String SAME_USER_SHOULD_NOT_BE_ABLE_TO_UPDATE_PARTY = "Same user should be able to update Location.";
	...
	private static final String ANY_USER_SHOULD_NOT_BE_ABLE_TO_UPDATE_UNLINKED = "Any user should NOT be able to update.";
	private static final String ANY_USER_SHOULD_NOT_BE_ABLE_TO_DELETE_UNLINKED = "Any user should NOT be able to delete.";
	...
	private static String PARTY = "{\"name\": \"Alice in Wonderland\", \"description\": \"The young girl that fell through a rabbit hole into a fantasy world of anthropomorphic creatures\", \"role\": \"individual\", \"authId\": \"%s\"}";
	...
	public void test10SameUserUpdateThingParty() throws ClientProtocolException, IOException {
		...
		String request = "{\"Party\":" + String.format(PARTY, ALICE) + "}";
		HttpPatch httpPatch = new HttpPatch(thingURL);
		HttpEntity stringEntity = new StringEntity(request, ContentType.APPLICATION_JSON);
		httpPatch.setEntity(stringEntity);
		setAuth(service, LJS, "");
