...
@SelectClasses({
    ...
    ObservationGroupTests.Imp10Tests.class,
    ObservationGroupTests.Imp11Tests.class,
    CampaignTests.Imp10Tests.class,
    CampaignTests.Imp11Tests.class,
    ...
    StorageCRSTests.Imp10Tests.class,
    StorageCRSTests.Imp11Tests.class
})
@Suite
@Testcontainers
