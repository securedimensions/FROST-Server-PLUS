...
public class TableImpProject extends StaTableAbstract<TableImpProject> {
    ...
    public void initProperties(final EntityFactories entityFactories) {
        ...
        pfReg.addEntryString(pluginPLUS.epTermsOfUse, table -> table.colTermsOfUse);
        pfReg.addEntryString(pluginPLUS.epPrivacyPolicy, table -> table.colPrivacyPolicy);
        pfReg.addEntryString(pluginPLUS.epUrl, table -> table.colUrl);

        pfReg.addEntry(pluginPLUS.epProjectCreated, table -> table.colCreatedTime,
                new ConverterTimeInstant<>(pluginPLUS.epProjectCreated, table -> table.colCreatedTime));
        pfReg.addEntry(pluginPLUS.epProjectRuntime,
                new ConverterTimeInterval<>(pluginPLUS.epProjectRuntime, table -> table.colRuntimeTimeStart, table -> table.colRuntimeTimeEnd),
