...
public class TableImpProjectsMultiDatastreams extends StaLinkTable<TableImpProjectsMultiDatastreams> {

    public static final String NAME_TABLE = "PROJECTS_MULTI_DATASTREAMS";
    public static final String NAME_COL_TL_DATASTREAM_ID = "MULTI_DATASTREAM_ID";
    public static final String NAME_COL_TL_PROJECT_ID = "PROJECT_ID";

    private static final long serialVersionUID = 1626971276;

    /**
     * The column <code>public.PROJECTS_MULTI_DATASTREAMS.PROJECT_ID</code>.
     */
    public final TableField<Record, ?> colProjectId;

    /**
     * The column <code>public.PROJECTS_MULTI_DATASTREAMS.DATASTREAM_ID</code>.
     */
    public final TableField<Record, ?> colMultiDatastreamId;

    /**
     * Create a <code>public.PROJECTS_MULTI_DATASTREAMS</code> table reference.
     *
     * @param idTypeProject The (SQL)DataType of the Id columns used in the actual
     * database.
     * @param idTypeMultiDatastream
     */
    public TableImpProjectsMultiDatastreams(DataType<?> idTypeProject, DataType<?> idTypeMultiDatastream) {
    ...
    private TableImpProjectsMultiDatastreams(Name alias, TableImpProjectsMultiDatastreams aliased) {
        super(alias, aliased);
    ...
    @Override
    public TableImpProjectsMultiDatastreams as(Name alias) {
        return new TableImpProjectsMultiDatastreams(alias, this).initCustomFields();
    }

    @Override
    public TableImpProjectsMultiDatastreams getThis() {
        return this;
    }
